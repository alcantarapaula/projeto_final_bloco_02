# Projeto Farmácia — Backend com NestJS
...
<div align="center">
  <img src="https://img.shields.io/github/languages/top/alcantarapaula/projeto_final_bloco_02?style=flat-square" />
  <img src="https://img.shields.io/github/repo-size/alcantarapaula/projeto_final_bloco_02?style=flat-square" />
  <img src="https://img.shields.io/github/languages/count/alcantarapaula/projeto_final_bloco_02?style=flat-square" />
  <img src="https://img.shields.io/github/last-commit/alcantarapaula/projeto_final_bloco_02?style=flat-square" />
  <img src="https://img.shields.io/github/issues/alcantarapaula/projeto_final_bloco_02?style=flat-square" />
  <img src="https://img.shields.io/github/issues-pr/alcantarapaula/projeto_final_bloco_02?style=flat-square" />
...
O **Projeto Farmácia** é uma API backend que permite que usuários publiquem, editem e visualizem produtos relacionados a diferentes categorias de forma organizada.
...
4. Consulta de produtos por categorias, nomes e id
5. Controle de acesso em operações protegidas relacionadas a usuários
...
permitindo a interação entre categorias e produtos cadastrados.
...
2. Gerenciamento de categorias para classificação dos produtos
3. Criação, edição, listagem e exclusão de produtos
4. Relacionamento entre produtos e categorias
...
```bash
git clone https://github.com/alcantarapaula/projeto_final_bloco_02.git
...
* Upload de imagens para usuários
